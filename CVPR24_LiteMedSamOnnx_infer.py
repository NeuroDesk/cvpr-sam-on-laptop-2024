...
# encoder_session = onnxruntime.InferenceSession(lite_medsam_checkpoint_path, providers=['CPUExecutionProvider'])
...
encoder_onnx_path = "work_dir/LiteMedSAM/lite_medsam_encoder_quant.quant.onnx"
...
def MedSAM_infer_npz_2D(img_npz_file):
    ...
    for idx, box in enumerate(boxes, start=1):
        ...
        medsam_mask, iou_pred = onnx_decoder_inference(medsam_lite_model, image_embedding, [], box256, (newh, neww), [H, W])
...
def MedSAM_infer_npz_3D(img_npz_file):
    ...
    for idx, box3D in enumerate(boxes_3D, start=1):
        ...
        for z in range(z_middle, z_max):
            ...
            img_2d_seg, iou_pred = onnx_decoder_inference(medsam_lite_model, image_embedding, [], box_256, [new_H, new_W], [H, W])
